...
# source: wave/service/interface.proto
...
Slots = _reflection.GeneratedProtocolMessageType(
    ...
    {
        'DESCRIPTOR': _SLOTS,
        '__module__': 'wave.service.interface_pb2'
