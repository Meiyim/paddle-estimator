...
_BYTESLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='atarashi.BytesList.value', index=0,
...
_FLOATLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='atarashi.FloatList.value', index=0,
...
_INT64LIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='atarashi.Int64List.value', index=0,
...
_FEATURE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='atarashi.Feature.tag', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bytes_list', full_name='atarashi.Feature.bytes_list', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='float_list', full_name='atarashi.Feature.float_list', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int64_list', full_name='atarashi.Feature.int64_list', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='atarashi.Feature.kind',
...
_EXAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='features', full_name='atarashi.Example.features', index=0,
