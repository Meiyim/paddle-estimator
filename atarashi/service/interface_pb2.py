...
# source: atarashi/service/interface.proto
...
Slots = _reflection.GeneratedProtocolMessageType(
    ...
    {
        'DESCRIPTOR': _SLOTS,
        '__module__': 'atarashi.service.interface_pb2'
