...
# source: atarashi/paddle/service/interface.proto
...
Slots = _reflection.GeneratedProtocolMessageType(
    ...
    {
        'DESCRIPTOR': _SLOTS,
        '__module__': 'atarashi.paddle.service.interface_pb2'
