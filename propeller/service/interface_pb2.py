...
# source: propeller/service/interface.proto
...
Slots = _reflection.GeneratedProtocolMessageType(
    ...
    {
        'DESCRIPTOR': _SLOTS,
        '__module__': 'propeller.service.interface_pb2'
